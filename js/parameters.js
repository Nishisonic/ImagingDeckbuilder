...
$( function () {
    ...
    httpObj.onload = function () {
        ...
        let mst_slotitem_equiptype = master.api_mst_slotitem_equiptype;
        for ( let i in mst_slotitem_equiptype ) {
            ITEM_TYPE2_DATA[ mst_slotitem_equiptype[ i ].api_id ] = mst_slotitem_equiptype[ i ].api_name;
        }
